...
public class SwedishView implements IView, BlackJack.model.rules.INewCardObserver 
    {
		@Override
        ...
        public void DisplayWelcomeMessage()
        {
            ...
            System.out.println("Skriv '" 
            					+ Options.PLAY.getOption() + "' för att Spela, '" 
            					+ Options.HIT.getOption() + "' för nytt kort, '"
            					+ Options.STAND.getOption() + "' för att stanna '" 
            					+ Options.QUIT.getOption() + "' för att avsluta\n");
        }
